...
namespace WpfApp1
{
    public partial class LopushokAxyonovContext : DbContext
    {
        ...
        public virtual DbSet<Prob> Probs { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=PC-232-01\\SQLEXPRESS;Database=LopushokAxyonov;Trusted_Connection=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Prob>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("Prob");

                entity.Property(e => e.НаимованиеМатериала)
                    .HasMaxLength(50)
                    .HasColumnName("Наимование материала");

                entity.Property(e => e.НеобходимоеКоличествоМатериала)
                    .HasMaxLength(50)
                    .HasColumnName("Необходимое количество материала");

                entity.Property(e => e.Продукция).HasMaxLength(50);
            });
